...
return array(
    'router' => array(
        'routes' => array(
            ...
            'db-api.rest.doctrine.loop' => array(
                'type' => 'Segment',
                'options' => array(
                    'route' => '/api/loop[/:loop_id]',
                    'defaults' => array(
                        'controller' => 'DbApi\\V1\\Rest\\Loop\\Controller',
                    ),
                ),
            ),
        ),
    ...
    'zf-rest' => array(
        ...
        'DbApi\\V1\\Rest\\Loop\\Controller' => array(
            'listener' => 'DbApi\\V1\\Rest\\Loop\\LoopResource',
            'route_name' => 'db-api.rest.doctrine.loop',
            ...
            'page_size' => 25,
            'page_size_param' => null,
            'entity_class' => 'Db\\Entity\\Loop',
            'collection_class' => 'DbApi\\V1\\Rest\\Loop\\LoopCollection',
        ),
    ),
    'zf-content-negotiation' => array(
        'controllers' => array(
            ...
            'DbApi\\V1\\Rest\\Loop\\Controller' => 'HalJson',
        ),
    ...
    'zf-hal' => array(
        'metadata_map' => array(
            ...
            'Db\\Entity\\Loop' => array(
                'route_identifier_name' => 'loop_id',
                'entity_identifier_name' => 'id',
                'route_name' => 'db-api.rest.doctrine.loop',
                'hydrator' => 'DbApi\\V1\\Rest\\Loop\\LoopHydrator',
                'max_depth' => 5,
            ),
            'DbApi\\V1\\Rest\\Loop\\LoopCollection' => array(
                'entity_identifier_name' => 'id',
                'route_name' => 'db-api.rest.doctrine.loop',
                'is_collection' => true,
                'max_depth' => 2,
    ...
    'zf-apigility' => array(
        'doctrine-connected' => array(
            ...
            'DbApi\\V1\\Rest\\Loop\\LoopResource' => array(
                'object_manager' => 'doctrine.entitymanager.orm_default',
                'hydrator' => 'DbApi\\V1\\Rest\\Loop\\LoopHydrator',
            ),
        ),
    ...
    'doctrine-hydrator' => array(
        ...
        'DbApi\\V1\\Rest\\Loop\\LoopHydrator' => array(
            'entity_class' => 'Db\\Entity\\Loop',
            'object_manager' => 'doctrine.entitymanager.orm_default',
            'by_value' => true,
            'hydrator_strategies' => array(),
